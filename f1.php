...
<body>
<table width="1251" height="1192" align="center">
    <?php include "header.php"; ?>

    <tr>
        <td height="39" colspan="4"><img src="images/futbolhaberleri-banner.png" width="1265" height="35" /></td>
    </tr>
    <tr>
        ...
        <td align="center">
            ...
            <div style="font: normal 11px Arial; width: 298px; border: solid 1px #ccc; background: #fff; border-radius: 3px; box-shadow: 1px 1px 3px #ccc;">
                <h2 style="padding: 8px; margin: 0; border: 0; border-bottom: solid 1px #ccc; margin-bottom:30px;">
                ...
                <iframe frameborder="0" width="298" height="282" src="https://www.trtspor.com.tr/puandurumu-ekle/?lig=1&renk=a&baslik=1&resimler=1&a=2"></iframe>
                <div style="text-align: center;line-height: 23px;border-top: solid 1px #ccc; color: #666; margin-top: 5px;box-shadow: 0 -1px 3px #ccc;">
                    <a style="text-decoration: none;color: #666; font: normal 11px Arial;" href="https://www.trtspor.com.tr/puandurumu_ekle.html" target="_blank">Ayrıntılı Puandurumu Tablosu</a>
                </div>
            </div>
    ...
    <tr style="border-top:1px solid;">
        <td height="89" colspan="4">
            ...
            $veri = $vt
                ->query(
                    "select * from yorumlar where haberid=$id and habertipi='futbol'"
                )
                ->fetchAll(PDO::FETCH_ASSOC);
