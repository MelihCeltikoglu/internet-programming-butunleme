...
<head>
    <meta charset="utf-8">
    <title>HABER SPOR Voleybol</title>
...
<table width="1251" height="1095" align="center">
    ...
    <tr>
        <td height="39" colspan="4"><img src="images/voleybolhaberleri-banner.png" width="1265" height="35" /></td>
    </tr>
    <tr>
        <td height="500" colspan="3"  style="border-right:1px solid;">
            <?php
            $id = null;
            if (isset($_GET["id"])) {
            ...
            <?php
            $veri = $vt
                ->query("select * from voleybol where id=$id")
    ...
    <tr>
        ...
        <td align="center"  style="padding-bottom:10px;">
            ...
            <div style="font: normal 11px Arial; width: 298px; border: solid 1px #ccc; background: #fff; border-radius: 3px; box-shadow: 1px 1px 3px #ccc;">
                <h2 style="padding: 8px; margin: 0; border: 0; border-bottom: solid 1px #ccc;">
                ...
                <iframe frameborder="0" width="298" height="282" src="https://www.trtspor.com.tr/sitene-ekle/voleybol-5/?haberSay=10&renk=a&baslik=1&resimler=1&a=4"></iframe>
                <div style="text-align: center;line-height: 23px;border-top: solid 1px #ccc; color: #666; margin-top: 5px;box-shadow: 0 -1px 3px #ccc;">
                    <a style="text-decoration: none;color: #666; font: normal 11px Arial;" href="https://www.trtspor.com.tr/">En Son Haberler</a> &nbsp;|&nbsp; <a style="text-decoration: none;color: #666; font: normal 11px Arial;" href="https://www.trtspor.com.tr/haber/voleybol/">Voleybol Haberleri</a>
                </div>
            </div>
    ...
    <tr style="border-top:1px solid;">
        <td height="89" colspan="4">
            ...
            $veri = $vt
                ->query(
                    "select * from yorumlar where haberid=$id and habertipi='voleybol'"
                )
                ->fetchAll(PDO::FETCH_ASSOC);
